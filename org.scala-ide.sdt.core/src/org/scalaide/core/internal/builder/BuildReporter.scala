...
import org.scalaide.core.internal.builder.TaskScanner
...
case class BuildProblem(severity: Reporter#Sevimport org.scalaide.core.internal.builder.BuildProblemMarker
erity, msg: String, pos: Position)
