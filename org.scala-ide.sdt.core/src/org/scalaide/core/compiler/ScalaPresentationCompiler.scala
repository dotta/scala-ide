...
import scala.tools.eclipse.JVMUtils
import scala.tools.eclipse.JavaSig
import scala.tools.eclipse.ScalaPlugin
import scala.tools.eclipse.ScalaProject
import scala.tools.eclipse.completion.MemberKind.Class
import scala.tools.eclipse.completion.MemberKind.Def
import scala.tools.eclipse.completion.MemberKind.Object
import scala.tools.eclipse.completion.MemberKind.Package
import scala.tools.eclipse.completion.MemberKind.PackageObject
import scala.tools.eclipse.completion.MemberKind.Trait
import scala.tools.eclipse.completion.MemberKind.Type
import scala.tools.eclipse.completion.MemberKind.Val
