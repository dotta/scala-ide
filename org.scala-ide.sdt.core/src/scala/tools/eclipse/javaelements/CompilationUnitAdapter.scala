...
object CompilationUnitAdapter {
  ...
  private class ScalaPackageDeclaration(_package: PackageFragment) extends IPackageDeclaration {
    ...
    @throws(classOf[JavaModelException]) override def getAnnotations(): Array[IAnnotation] = throw new UnsupportedOperationException
    @throws(classOf[JavaModelException]) override def getNameRange: ISourceRange = throw new UnsupportedOperationException
    @throws(classOf[JavaModelException]) override def getSourceRange: ISourceRange = throw new UnsupportedOperationException
    @throws(classOf[JavaModelException]) override def getSource: String = throw new UnsupportedOperationException
    override def exists(): Boolean = throw new UnsupportedOperationException

    @throws(classOf[JavaModelException]) override def isStructureKnown: Boolean = throw new UnsupportedOperationException
    @throws(classOf[JavaModelException]) override def isReadOnly: Boolean = throw new UnsupportedOperationException
    @throws(classOf[JavaModelException]) override def getUnderlyingResource: IResource = throw new UnsupportedOperationException
    ...
    @throws(classOf[JavaModelException]) override def getCorrespondingResource: IResource = throw new UnsupportedOperationException
    @throws(classOf[JavaModelException]) override def getAttachedJavadoc(monitor: IProgressMonitor): String = throw new UnsupportedOperationException
